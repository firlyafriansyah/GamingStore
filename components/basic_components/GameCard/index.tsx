    ...
    <div data-aos="fade-up" className={styles.container}>
      <a href="#" className={styles.wrapper}>
        <div className={styles['glass-image']}>
          <Image className={styles['glass-image-game']} src={image} width={205} height={275} alt="game-card-image" priority />
        ...
        <Image className={styles['game-card']} src={image} width={205} height={275} alt="game-card-image" priority />
      </a>
    </div>
  )
}